#!/usr/bin/env python3
"""
Test controller server for Phase 2.
Manages the WebSocket server, alignment server, and quality server as subprocesses.
...
SERVERS = {
    ...
    "quality":     _py_server("Quality Analysis",   21748, "quality_server.py",
                              extra_args=["--port", "21748"]),
}
...
def main():
    ...
    print(f"  [controller] Phase 2 test controller running on http://127.0.0.1:{port}")
