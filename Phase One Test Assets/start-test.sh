#!/usr/bin/env bash
# Phase 1 Test Launcher
# Starts the test controller (which manages WS + alignment servers)
...
if [ "$1" = "stop" ]; then
  ...
  lsof -ti :8098 :8099 :21740 :21741 :21742 :21743 :21744 :21745 :21746 :21747 2>/dev/null | xargs kill 2>/dev/null || true
  echo "Stopped."
  exit 0
fi
...
echo -e "${GREEN}=== Phase 1 Test Suite ===${NC}"
echo ""

# 1) Start controller (manages WS + alignment servers)
...
echo -e "  the WebSocket server and alignment server."
echo ""
